...
String flprogBoardInfo::getUartBoardInfo()
{
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART0_RX)) + "\n ";
#endif

#ifdef FLPROG_UART0_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART0_TX)) + " \n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART1_RX)) + "\n ";
#endif

#ifdef FLPROG_UART1_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART1_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART2_RX)) + "\n ";
#endif

#ifdef FLPROG_UART2_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART2_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART3_RX)) + "\n ";
#endif

#ifdef FLPROG_UART3_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART3_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART4_RX)) + "\n ";
#endif

#ifdef FLPROG_UART4_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART4_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART5_RX)) + "\n ";
#endif

#ifdef FLPROG_UART5_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART5_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART6_RX)) + "\n ";
#endif

#ifdef FLPROG_UART6_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART6_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART7_RX)) + "\n ";
#endif

#ifdef FLPROG_UART7_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART7_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART8_RX)) + "\n ";
#endif

#ifdef FLPROG_UART8_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART8_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART9_RX)) + "\n ";
#endif

#ifdef FLPROG_UART9_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART9_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART10_RX)) + "\n ";
#endif

#ifdef FLPROG_UART10_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART10_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART11_RX)) + "\n ";
#endif

#ifdef FLPROG_UART11_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART11_TX)) + "\n";
#endif
#endif
    ...
    result = result + "        RX:" + flprogBoardInfo::getPinName((FLPROG_UART12_RX)) + "\n ";
#endif

#ifdef FLPROG_UART12_TX
    result = result + "       TX:" + flprogBoardInfo::getPinName((FLPROG_UART12_TX)) + "\n";
#endif
#endif
